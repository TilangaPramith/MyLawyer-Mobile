...
class OldAppointmentScreen extends React.Component {
    constructor(){
        super();
        this.panResponder;
        this.state  = {
    ...
    async componentDidMount(){
        console.log('mount');
        Axios.get('http://192.168.43.133:3001/appointment/old')
        .then(res => {
        ...
        return (
                <TouchableWithoutFeedback onPress = {() => {Keyboard.dismiss();}} >
                    <View style = {styles.screen} >
                        <Text style = {styles.title}>Old Appointments</Text>
                        {/* <Text>{this.state.appoint[0]}</Text> */}
