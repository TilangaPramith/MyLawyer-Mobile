...
class OldCaseScreen extends React.Component {
    ...
    async componentDidMount(){
        console.log('mount');
        Axios.get('http://192.168.43.133:3001/case/old')
        .then(res => {
    ...
    render () {
        ...
        return (
            ...
            <View style = {styles.screen} >
                <Text style = {styles.title}>Old Cases</Text>
