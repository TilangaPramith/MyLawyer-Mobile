...
class CurrentDeedScreen extends React.Component {
    ...
    async componentDidMount(){
        console.log('mount');
        Axios.get('http://192.168.43.133:3001/deed/current')
        .then(res => {
        ...
        return (
            <TouchableWithoutFeedback onPress = {() => {Keyboard.dismiss();}} >
                <View style = {styles.screen} >
                    <Text style = {styles.title}>Current Deeds</Text>
...
export default CurrentDeedScreen;